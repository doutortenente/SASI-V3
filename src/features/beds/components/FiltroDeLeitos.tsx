        ...
        <section aria-label="Filtros da grade" className="mb-4 flex flex-wrap items-center gap-2">
            ...
            <label className="relative min-w-40 flex-1 sm:max-w-64">
                ...
                <input
                    ...
                    className="min-h-11 w-full rounded-md border border-borda-padrao bg-superficie-card pr-2.5 pl-8 text-sm text-texto-corpo placeholder:text-texto-tenue focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
                />
            </label>
            ...
            {temFiltroAtivo && (
                <button
                    type="button"
                    onClick={aoLimpar}
                    className="flex min-h-11 items-center gap-1 rounded-md px-2 text-xs font-medium text-texto-suave hover:text-texto-titulo"
                >
            ...
            {temFiltroAtivo && (
                <p aria-live="polite" data-clinical-number className="text-xs text-texto-suave">
