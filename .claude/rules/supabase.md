...
| ------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| "`vw_sofa_diario` é só um comentário, o motor não foi escrito"     | A view **existe**, com 6.660 caracteres e os 6 sistemas. A migration a omite **de propósito** — está escrito na linha 752: _"mantido conforme banco vivo"_. Existe também `vw_sofa_trend_72h`, que não consta em documento nenhum |
